...
#ifndef __IPMETA_PROVIDER_NETACQ_EDGE_H
#define __IPMETA_PROVIDER_NETACQ_EDGE_H

#include "ipmeta_provider.h"

/** @file
 *
 * @brief Header file that exposes the ipmeta Net Acuity Edge provider
...
IPMETA_PROVIDER_GENERATE_PROTOS(netacq_edge)

#endif /* __IPMETA_PROVIDER_NETACQ_EDGE_H */
